...
class IndexPageTests(TestCase):
    ...
    def test_index_using_template(self):
        ...
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertTemplateUsed(response, 'rangoapp/index.html')
...
class AboutPageTests(TestCase):
    ...
    def test_about_using_template(self):
        ...
        self.assertTemplateUsed(response, 'rangoapp/about.html')
...
class ModelTests(TestCase):
    ...
    def setUp(self):
        try:
            from scripts.populate_rangoapp import populate
            populate()
        except ImportError:
...
class Chapter5ViewTests(TestCase):
    ...
    def test_admin_interface_page_view(self):
        from rangoapp.admin import PageAdmin
